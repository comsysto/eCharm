...
def upgrade():
    ...
    op.add_column('stations', sa.Column('coordinates', Geometry(geometry_type='POINT'), nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('stations', sa.Column('street', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('stations', sa.Column('house_number', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('stations', sa.Column('city', sa.VARCHAR(), autoincrement=False, nullable=True))
