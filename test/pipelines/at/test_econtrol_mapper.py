            ...
            pd.Series(
                {
                    ...
                    "location": {"latitude": 48.456161, "longitude": 14.349852},
                    ...
                    "points": [
                        {
                            ...
                            "roaming": True,
                            "status": "UNKNOWN",
                            "vehicleTypes": ["CAR", "BICYCLE", "MOTORCYCLE"],
                        }
                    ],
                    "postCode": "4204",
                    "public": True,
            ...
            pd.Series(
                {
                    ...
                    "greenEnergy": True,
                    "label": "Marktplatz/Gemeindeamt",
                    "location": {"latitude": 48.111, "longitude": 14.222},
                }
            ),
            {
                "source_id": "AT*000*EREI001",
    ...
    datapoint = pd.Series(
        {
            "points": [
                ...
                },
                {
                    ...
                    "energyInKw": 15,
                    "location": {
                        "latitude": 48.198523499134545,
                        "longitude": 16.325340999197394,
                    },
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            pd.Series([{"test_attr": ["a", "b", "c"]}, {"test_attr": ["d", "e", "f"]}]),
            "test_attr",
            [["a", "b", "c"], ["d", "e", "f"]],
        ),
