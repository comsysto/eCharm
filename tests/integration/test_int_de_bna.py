...
from charging_stations_pipelines.file_utils import load_excel_file
...
def bna_data():
    ...
    with tempfile.NamedTemporaryFile() as temp_file:
        bna_file: Path = Path(temp_file.name)
        ...
        get_bna_data(bna_file)

        bna_in_data: pd.DataFrame = load_excel_file(bna_file)

        yield bna_file, bna_in_data
